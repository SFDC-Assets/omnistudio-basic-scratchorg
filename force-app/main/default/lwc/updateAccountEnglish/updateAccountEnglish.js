...
import { OMNIDEF } from './updateAccountEnglish_def.js';
import tmpl from './updateAccountEnglish.html';
import tmpl_nds from './updateAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class updateAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
